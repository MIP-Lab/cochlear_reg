...
class MyTrainer(Trainer):
    ...
    def test_loss(self, model, input_data):
        ...
        write_mesh_file(MD_pred, MD_triangles, f'{self.exp_dir}/evaluation/predicted_mesh/MD/{case}.mesh')
        write_mesh_file(ST_pred, ST_triangles, f'{self.exp_dir}/evaluation/predicted_mesh/ST/{case}.mesh')
        write_mesh_file(SV_pred, SV_triangles, f'{self.exp_dir}/evaluation/predicted_mesh/SV/{case}.mesh')
        write_mesh_file(CC_pred, CC_triangles, f'{self.exp_dir}/evaluation/predicted_mesh/CC/{case}.mesh')
